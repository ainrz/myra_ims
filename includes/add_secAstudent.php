<?php 
			...
			if (isset($_POST['add'])) {
				...
				$query = "INSERT INTO ug_student(matric_num, stud_name, fac, yr_enroll, academic_yr, citizenship, country, status, remarks) ";

				// masukkan data kt table staff

				$query .= "VALUES('$matric_num', '$stud_name', '$fac', '$yr_enroll', '$academic_yr', '$citizenship', '$country', '$status', 'remarks')";
...
<div class="row">
	...
	<div class="row">
	    <div class="col-lg-6">
	        <h3 class="page-header">Undergaduate Student</h3>
